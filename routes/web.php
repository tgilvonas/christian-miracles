...
Route::get('/saints/json', [FrontendSaintsController::class, 'getJsonList'])->name('saints.json_list');
Route::get('/saints/{slug}', [FrontendSaintsController::class, 'show'])->name('saints.show_en');
Route::get('/sventieji/{slug}', [FrontendSaintsController::class, 'show'])->name('saints.show_lt');
